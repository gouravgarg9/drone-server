package com.droneserver.demo.utils;
...
public final class ProtoData {
  ...
  public interface DroneDataOrBuilder extends
    ...
    /**
     * <code>int32 mq135 = 9;</code>
     */
    int getMq135();

    /**
     * <code>int32 mq2 = 10;</code>
     */
    int getMq2();

    /**
     * <code>float distance = 11;</code>
     */
    float getDistance();

    /**
     * <code>float temperature = 12;</code>
     */
    float getTemperature();

    /**
     * <code>float humidity = 13;</code>
     */
    float getHumidity();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              mq135_ = input.readInt32();
              break;
            }
            case 80: {

              mq2_ = input.readInt32();
              break;
            }
            case 93: {
    ...
    public static final int MQ135_FIELD_NUMBER = 9;
    private int mq135_;
    /**
     * <code>int32 mq135 = 9;</code>
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (mq135_ != 0) {
        output.writeInt32(9, mq135_);
      }
      if (mq2_ != 0) {
        output.writeInt32(10, mq2_);
      }
      if (distance_ != 0F) {
      ...
      if (humidity_ != 0F) {
        output.writeFloat(13, humidity_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (mq135_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(9, mq135_);
      }
      if (mq2_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(10, mq2_);
      }
      if (distance_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rone_id\030\010 \001(\t\022\r\n\005mq135\030\t \001(\005\022\013\n\003mq2\030\n \001(" +
      "\005\022\020\n\010distance\030\013 \001(\002\022\023\n\013temperature\030\014 \001(\002" +
      "\022\020\n\010humidity\030\r \001(\002\"a\n\tDataPoint\022\020\n\010latit" +
      "ude\030\001 \001(\t\022\021\n\tlongitude\030\002 \001(\t\022\020\n\010altitude" +
      "\030\003 \001(\002\022\r\n\005speed\030\004 \001(\002\022\016\n\006action\030\005 \001(\005\"(\n" +
      "\013MissionData\022\031\n\005point\030\001 \003(\0132\n.DataPointb" +
      "\006proto3"
    };
    ...
    internal_static_DroneData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DroneData_descriptor,
        new java.lang.String[] { "Altitude", "Latitude", "Longitude", "Voltage", "Speed", "State", "VideoPort", "DroneId", "Mq135", "Mq2", "Distance", "Temperature", "Humidity", });
    internal_static_DataPoint_descriptor =
