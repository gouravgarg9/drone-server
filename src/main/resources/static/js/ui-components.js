...
const renderDroneUIComponent = function (droneDTO) {
    ...
    return '<div id="ctrlPanel1'+droneDTO.id+'" droneId="'+droneDTO.id+'" class="dronesList-header" );">Drone: '+droneDTO.id +
        ...
        '<span><label> Voltage (V): </label> <input type="text" id="infoBat'+droneDTO.id+'" size="2" value="'+droneDTO.battery+'" disabled /></span>' +
        '<span><label> MQ-135 (ppm): </label> <input type="text" id="infoMq135'+droneDTO.id+'" size="2" value="'+droneDTO.mq135+'" disabled /></span>' +
        '<span><label> MQ-2 (ppm): </label> <input type="text" id="infoMq2'+droneDTO.id+'" size="2" value="'+droneDTO.mq2+'" disabled /></span>' +
